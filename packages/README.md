...
The three published packages. Only the two platform packages are installed
directly - `kyc-core` arrives as a dependency.
...
All three publish to GitHub Packages at the same version, with `kyc-core`
